...
namespace BrowserAutomationMaster.Managers 
{
    ...
    public class UnixFilePermissionManager() 
    {
        ...
        private static extern int access(string path, int amode);
        ...
        private static extern int chmod(string pathname, UInt32 mode);
